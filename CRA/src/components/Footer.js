			...
			<div id="footer">
				<footer>
					<div className="content">
						<a href="https://medieteknik.nu/" target="_blank" rel="noopener noreferrer">
					...
					<div className="content">
						<ul>
							...
							<li>
								<Link to={settings.url + general[this.state.lang].acceptPolicyLink.url + "/"}>{content[this.state.lang].privacyPol}</Link>
							</li>
						</ul>
					</div>
					...
					<div className="content">
						<ul>
							<li>
								{`${general[this.state.lang].name} ${general.year} - ${general[this.state.lang].date}`}
							</li>
							<li>
								Linköpings Universitet, Campus Norrköping, Bredgatan 34, Norrköping
							</li>
						</ul>
					</div>
					...
					<div className="content">
						<ul>
							<li>
								{general[this.state.lang].follow}
							</li>
							<li>
