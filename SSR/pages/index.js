...
import companyInformation from "./content/companyInformation.json";
...
class Home extends Component {
	...
	render() {
		...
		// 			<Link to={settings.url + "companies/" + item.inURL} className="partner">
		...
		// 	description.push(<p className="readMore" style={{ color: "#ccc" }} key={description.length}>{home[this.state.lang].press}</p>);
			...
			<div id="homeWrap">
					...
					<footer id="beamerSharebar">
						<div className="footCont">
							...
							<a href="https://facebook.com/medieteknikdagarna" target="_blank" rel="noopener noreferrer">
								<FontAwesomeIcon icon={['fab', 'facebook-square']} className="fa"></FontAwesomeIcon>
								<p>facebook</p>
							</a>
							<a href="https://youtube.com/mtdagarna" target="_blank" rel="noopener noreferrer">
								<FontAwesomeIcon icon={['fab', 'youtube-square']} className="fa"></FontAwesomeIcon>
								<p>youtube</p>
							</a>
							<a href="https://www.instagram.com/medieteknikdagarna/" target="_blank" rel="noopener noreferrer">
								<FontAwesomeIcon icon={['fab', 'instagram']} className="fa"></FontAwesomeIcon>
								<p>instagram</p>
							</a>
							<a href="https://www.linkedin.com/company/medieteknikdagarna-2014/" target="_blank" rel="noopener noreferrer">
								<FontAwesomeIcon icon={['fab', 'linkedin']} className="fa"></FontAwesomeIcon>
								<p>linkedin</p>
							</a>
						</div>
					</footer>
					<div id="homeChevron_down" className="chevron">
						<FontAwesomeIcon icon="chevron-down" className="fa"></FontAwesomeIcon>
					</div>
				</div>
				...
				<div id="landingContent">
					...
					<div id="silverPartners">
						<h2>
							{home[this.state.lang].silverPartnersTitle}
						</h2>
